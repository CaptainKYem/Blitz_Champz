...
public class Deck : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //All of the for loops focus on creating and instantiating all of the cards in the deck
        for (int a = 0; a < 2; a++) {
        ...
        //Deals with storing the location of all the cards.
        gameObject.GetComponent<Transform>().position = gameObject.transform.position + new Vector3(0f, 0f, -2);
        ready = true;
        Debug.Log("Deck made");
    }

    //Deals with randimizing the cards the user gets.
